...
<body>
  ...
  <script>
    ...
    function changeQR() {      
      var qrcode = new QRCode("qrcode", '{"subject":"<?php date_default_timezone_set("Asia/Manila"); echo $_SESSION['subject'];?>","date":"<?php $date=date_create(); echo date_format($date,"Y/m/d H:i:s");?>"}');
