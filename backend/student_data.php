...
try {
    ...
    if (mysqli_query($con, $query)) {
        ...
        $action_button = '<a href="../index.php" class="button_submit" style="text-decoration:none; display:inline-block; width:auto; padding: 10px 30px;">Go to Login</a>';
    }
    ...
    if ($e->getCode() == 1062) { 
        ...
        } elseif (strpos($error_msg, 'roll_no') !== false) {
            $message = "This LRN Number is already registered.";
        } else {
